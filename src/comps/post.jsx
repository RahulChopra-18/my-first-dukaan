                    ...
                    <form>
                        <div style={{ display: "flex", padding: "20px " }}>
                            ...
                            <select className="selector" style={{ margin: "auto", width: "50%", height: "50px", fontSize: "18px" }}>
                                ...
                                <option value="Cars" style={select}>Automobile</option>
                                <option value="Motorcycle" style={select}>Fitness-equipment</option>
                                <option value="Houses" style={select}>Furniture</option>
                                <option value="TV-Video-Audio" style={select}>TV-Video-Audio</option>
                                <option value="Tablets" style={select}>Tablets</option>
                                <option value="Lands&Plots" style={select}>Beauty-Products</option>
                            </select>
                        </div>
                        <hr style={{ color: "#ccc" }} />
